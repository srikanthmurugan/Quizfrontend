...
function Register() {
    ...
    const submit = async e => {
        ...
        dispatch(signUpUser({username, email, password1, password2}))
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div>
                                    ...
                                    <input onChange={e => setUsername(e.target.value)}
                                        ...
                                        name="username"
                                        type="text"
                                        className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="should_be_unique" required=""></input>
                                </div>
                                <div>
                          ...
                          <div class="ml-3 text-sm">
                            <label for="remember" class="text-gray-500 dark:text-gray-300">Remember me</label>
                                ...
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Already have an account yet? <a href="/login" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Login</a>
                                </p>
                            </form>
                        </div>
                    </div>
